"""Deploy this workspace's git-tracked items via fabric-cicd.

TEMPORARY COPY — this is duplicated from ms-fabric-platform-core/scripts/deploy_fabric_item.py
because this repo's workflow can't currently call platform-core's reusable workflow
(Actions cross-repo access isn't granted yet). Delete this file and switch
.github/workflows/deploy-test.yml back to `uses: vtiyer89/ms-fabric-platform-core/...`
once that's sorted — see docs/fabric-test-workspace-sync.md in ms-fabric-platform-core.
